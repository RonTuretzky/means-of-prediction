...
Coordinator model may change. The experimental generator/teacher remains
`gpt-6-astra`, explicitly selected by
`/Users/wk/conductor/workspaces/research/porto-novo/app/scripts/research/blind/astra_transport.py`.
...
> local processing and bounded subagents where useful. Keep Astra as generator
